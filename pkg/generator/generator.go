...
func NewFileGenerator(f *protogen.File, gen *protogen.Plugin, opt Options) *FileGenerator {
	gen.SupportedFeatures |= uint64(pluginpb.CodeGeneratorResponse_FEATURE_PROTO3_OPTIONAL)

	return &FileGenerator{f: f, gen: gen, opt: opt}
}
